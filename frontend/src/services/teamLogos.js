...
export const getTeamLogo = async (teamName, sport = 'Soccer') => {
  ...
  const footballLogos = {
    ...
    'Osasuna': 'https://upload.wikimedia.org/wikipedia/en/d/d2/CA_Osasuna_logo.svg',
    ...
    'Deportivo Alavés': 'https://upload.wikimedia.org/wikipedia/en/6/6e/Deportivo_Alav%C3%A9s_logo.svg',
    'Espanyol': 'https://upload.wikimedia.org/wikipedia/en/7/73/RCD_Espanyol_logo.svg',
    'Rayo Vallecano': 'https://upload.wikimedia.org/wikipedia/en/1/13/Rayo_Vallecano_logo.svg',
    ...
    'Cádiz CF': 'https://upload.wikimedia.org/wikipedia/en/5/58/C%C3%A1diz_CF_logo.svg',
    'Cadiz': 'https://upload.wikimedia.org/wikipedia/en/5/58/C%C3%A1diz_CF_logo.svg',
    'Granada': 'https://upload.wikimedia.org/wikipedia/en/c/c1/Granada_CF_logo.svg',
    'Almería': 'https://upload.wikimedia.org/wikipedia/en/c/cf/UD_Almeria_logo.svg',
    'Almeria': 'https://upload.wikimedia.org/wikipedia/en/c/cf/UD_Almeria_logo.svg',
    'Leganés': 'https://upload.wikimedia.org/wikipedia/en/6/69/CD_Legan%C3%A9s_logo.svg',
    ...
    'Sporting Gijón': 'https://upload.wikimedia.org/wikipedia/en/3/31/Real_Sporting_de_Gij%C3%B3n_SAD_logo.svg',
    ...
    'Burgos CF': 'https://upload.wikimedia.org/wikipedia/en/2/2f/Burgos_CF_logo.svg',
    'CD Mirandés': 'https://upload.wikimedia.org/wikipedia/en/f/f8/CD_Mirand%C3%A9s_logo.svg',
    'Deportivo La Coruña': 'https://upload.wikimedia.org/wikipedia/en/4/47/Deportivo_La_Coru%C3%B1a_logo.svg',
    'Real Zaragoza': 'https://upload.wikimedia.org/wikipedia/en/c/c8/Real_Zaragoza_SAD_logo.svg',
    'Real Oviedo': 'https://upload.wikimedia.org/wikipedia/en/4/48/Real_Oviedo_logo.svg',
    'Córdoba CF': 'https://upload.wikimedia.org/wikipedia/en/2/29/C%C3%B3rdoba_CF_logo.svg',
    
    // Turkish Super Lig
    'Galatasaray': 'https://upload.wikimedia.org/wikipedia/en/e/e8/Galatasaray_Sports_Club_Logo.png',
    'Fenerbahce': 'https://upload.wikimedia.org/wikipedia/en/8/86/Fenerbahce_SK_Logo.svg',
    'Fenerbahçe': 'https://upload.wikimedia.org/wikipedia/en/8/86/Fenerbahce_SK_Logo.svg',
    'Besiktas': 'https://upload.wikimedia.org/wikipedia/en/3/3f/Besiktas_JK_logo.svg',
    'Besiktas JK': 'https://upload.wikimedia.org/wikipedia/en/3/3f/Besiktas_JK_logo.svg',
    'Beşiktaş': 'https://upload.wikimedia.org/wikipedia/en/3/3f/Besiktas_JK_logo.svg',
    'Beşiktaş JK': 'https://upload.wikimedia.org/wikipedia/en/3/3f/Besiktas_JK_logo.svg',
    'Trabzonspor': 'https://upload.wikimedia.org/wikipedia/en/5/5c/Trabzonspor_logo.svg',
    'Basaksehir': 'https://upload.wikimedia.org/wikipedia/en/4/45/Istanbul_Basaksehir_FK_logo.svg',
    'Başakşehir': 'https://upload.wikimedia.org/wikipedia/en/4/45/Istanbul_Basaksehir_FK_logo.svg',
    'Antalyaspor': 'https://upload.wikimedia.org/wikipedia/en/5/5f/Antalyaspor_logo.svg',
    'Alanyaspor': 'https://upload.wikimedia.org/wikipedia/en/7/7c/Alanyaspor_logo.svg',
    'Kasimpasa': 'https://upload.wikimedia.org/wikipedia/en/5/56/Kasimpasa_logo.svg',
    'Kasimpasa SK': 'https://upload.wikimedia.org/wikipedia/en/5/56/Kasimpasa_logo.svg',
    'Kasımpaşa': 'https://upload.wikimedia.org/wikipedia/en/5/56/Kasimpasa_logo.svg',
    'Kasımpaşa SK': 'https://upload.wikimedia.org/wikipedia/en/5/56/Kasimpasa_logo.svg',
    'Sivasspor': 'https://upload.wikimedia.org/wikipedia/en/d/db/Sivasspor_logo.svg',
    'Konyaspor': 'https://upload.wikimedia.org/wikipedia/en/4/4f/Konyaspor_logo.svg',
    'Torku Konyaspor': 'https://upload.wikimedia.org/wikipedia/en/4/4f/Konyaspor_logo.svg',
    'Kayserispor': 'https://upload.wikimedia.org/wikipedia/en/b/bb/Kayserispor_logo.svg',
    'Gaziantep': 'https://upload.wikimedia.org/wikipedia/en/4/4e/Gaziantep_FK_logo.svg',
    'Gazişehir Gaziantep': 'https://upload.wikimedia.org/wikipedia/en/4/4e/Gaziantep_FK_logo.svg',
    'Samsunspor': 'https://upload.wikimedia.org/wikipedia/en/9/9d/Samsunspor_logo.svg',
    'Rizespor': 'https://upload.wikimedia.org/wikipedia/en/1/1c/Caykur_Rizespor_logo.svg',
    'Çaykur Rizespor': 'https://upload.wikimedia.org/wikipedia/en/1/1c/Caykur_Rizespor_logo.svg',
    'Göztepe': 'https://upload.wikimedia.org/wikipedia/en/7/74/G%C3%B6ztepe_SK_logo.svg',
    'Goztepe': 'https://upload.wikimedia.org/wikipedia/en/7/74/G%C3%B6ztepe_SK_logo.svg',
    'Eyüpspor': 'https://upload.wikimedia.org/wikipedia/en/4/48/Ey%C3%BCpspor_logo.svg',
    'Fatih Karagümrük': 'https://upload.wikimedia.org/wikipedia/en/2/29/Fatih_Karag%C3%BCmr%C3%BCk_SK_logo.svg',
    'Kocaelispor': 'https://upload.wikimedia.org/wikipedia/en/4/46/Kocaelispor_logo.svg',
    'Genclerbirligi': 'https://upload.wikimedia.org/wikipedia/en/f/f7/Gen%C3%A7lerbirli%C4%9Fi_SK_logo.svg',
    'Genclerbirligi SK': 'https://upload.wikimedia.org/wikipedia/en/f/f7/Gen%C3%A7lerbirli%C4%9Fi_SK_logo.svg',
    ...
    'Lyon': 'https://upload.wikimedia.org/wikipedia/commons/c/c1/Olympique_Lyonnais_logo.svg',
    'AS Monaco': 'https://upload.wikimedia.org/wikipedia/en/e/ea/AS_Monaco_FC_Logo.svg',
    'Monaco': 'https://upload.wikimedia.org/wikipedia/en/e/ea/AS_Monaco_FC_Logo.svg',
    'Lille': 'https://upload.wikimedia.org/wikipedia/en/b/b9/Lille_OSC_%28logo%29.svg',
    'Nice': 'https://upload.wikimedia.org/wikipedia/en/a/aa/OGC_Nice_logo.svg',
    'Lens': 'https://upload.wikimedia.org/wikipedia/en/5/5e/RC_Lens_logo.svg',
    ...
    'Nantes': 'https://upload.wikimedia.org/wikipedia/en/6/66/FC_Nantes_logo.svg',
    'Reims': 'https://upload.wikimedia.org/wikipedia/en/a/a3/Stade_Reims_logo.svg',
    'Toulouse': 'https://upload.wikimedia.org/wikipedia/en/8/83/Toulouse_FC_logo.svg',
    'Brest': 'https://upload.wikimedia.org/wikipedia/en/b/b5/Stade_Brest_29_logo.svg',
    'Auxerre': 'https://upload.wikimedia.org/wikipedia/en/b/b2/AJ_Auxerre_Logo.svg',
    'Angers': 'https://upload.wikimedia.org/wikipedia/en/3/30/Angers_SCO_logo.svg',
    'Saint-Étienne': 'https://upload.wikimedia.org/wikipedia/en/2/25/AS_Saint-%C3%89tienne_logo.svg',
    'Le Havre': 'https://upload.wikimedia.org/wikipedia/en/1/1e/Le_Havre_AC_logo.svg',
    'Metz': 'https://upload.wikimedia.org/wikipedia/en/9/93/FC_Metz_logo.svg',
    'Paris FC': 'https://upload.wikimedia.org/wikipedia/en/e/e2/Paris_FC_logo.svg',
    'Lorient': 'https://upload.wikimedia.org/wikipedia/en/c/c7/FC_Lorient_logo.svg',
    
    // Ligue 2
    'Bordeaux': 'https://upload.wikimedia.org/wikipedia/en/3/34/FC_Girondins_de_Bordeaux_Logo.svg',
    'Guingamp': 'https://upload.wikimedia.org/wikipedia/en/4/4d/En_Avant_Guingamp_logo.svg',
    'Bastia': 'https://upload.wikimedia.org/wikipedia/en/a/a6/SC_Bastia_logo.svg',
    'Grenoble': 'https://upload.wikimedia.org/wikipedia/en/e/ee/Grenoble_Foot_38_logo.svg',
    'Caen': 'https://upload.wikimedia.org/wikipedia/en/3/31/Stade_Malherbe_Caen_Logo.svg',
    'Ajaccio': 'https://upload.wikimedia.org/wikipedia/en/c/c0/AC_Ajaccio_logo.svg',
    'Troyes': 'https://upload.wikimedia.org/wikipedia/en/a/a2/ES_Troyes_AC_logo.svg',
    'Laval': 'https://upload.wikimedia.org/wikipedia/en/7/7d/Stade_Lavallois_logo.svg',
    'Pau FC': 'https://upload.wikimedia.org/wikipedia/en/c/c1/Pau_FC_logo.svg',
    'Rodez AF': 'https://upload.wikimedia.org/wikipedia/en/d/db/Rodez_AF_logo.svg',
    'Amiens': 'https://upload.wikimedia.org/wikipedia/en/e/e3/Amiens_SC_logo.svg',
    'Clermont': 'https://upload.wikimedia.org/wikipedia/en/9/95/Clermont_Foot_63_logo.svg',
    'Annecy FC': 'https://upload.wikimedia.org/wikipedia/en/d/d2/FC_Annecy_logo.svg',
    ...
    'Santos': 'https://upload.wikimedia.org/wikipedia/commons/3/33/Santos_logo.svg',
    ...
    'Atlético Mineiro': 'https://upload.wikimedia.org/wikipedia/en/e/ed/Atletico_Mineiro_logo.svg',
    'Clube Atlético Mineiro': 'https://upload.wikimedia.org/wikipedia/en/e/ed/Atletico_Mineiro_logo.svg',
    ...
    'Botafogo': 'https://upload.wikimedia.org/wikipedia/en/e/ec/Botafogo_FR_logo.svg',
    'Vasco da Gama': 'https://upload.wikimedia.org/wikipedia/en/a/ac/Club_de_Regatas_Vasco_da_Gama_logo.svg',
    'Athletico Paranaense': 'https://upload.wikimedia.org/wikipedia/en/e/e9/Club_Athletico_Paranaense_logo.svg',
    'Fortaleza': 'https://upload.wikimedia.org/wikipedia/en/a/ab/Fortaleza_Esporte_Clube_logo.svg',
    'Cruzeiro': 'https://upload.wikimedia.org/wikipedia/en/9/98/Cruzeiro_Esporte_Clube_logo.svg',
    'Bahia': 'https://upload.wikimedia.org/wikipedia/en/4/43/Esporte_Clube_Bahia_logo.svg',
    'Vitória': 'https://upload.wikimedia.org/wikipedia/en/b/b8/Esporte_Clube_Vit%C3%B3ria_logo.svg',
    'Sport Recife': 'https://upload.wikimedia.org/wikipedia/en/8/8f/Sport_Club_do_Recife_logo.svg',
    'Ceará': 'https://upload.wikimedia.org/wikipedia/en/7/71/Cear%C3%A1_Sporting_Club_logo.svg',
    'Coritiba': 'https://upload.wikimedia.org/wikipedia/en/f/f7/Coritiba_Foot_Ball_Club_logo.svg',
    'Juventude': 'https://upload.wikimedia.org/wikipedia/en/f/f4/Esporte_Clube_Juventude_logo.svg',
    'Bragantino': 'https://upload.wikimedia.org/wikipedia/en/9/98/Red_Bull_Bragantino_logo.svg',
    'Bragantino-SP': 'https://upload.wikimedia.org/wikipedia/en/9/98/Red_Bull_Bragantino_logo.svg',
    'Cuiabá': 'https://upload.wikimedia.org/wikipedia/en/0/0c/Cuiab%C3%A1_Esporte_Clube_logo.svg',
    'Goiás': 'https://upload.wikimedia.org/wikipedia/en/6/6f/Goias_Esporte_Clube_logo.svg',
    'América Mineiro': 'https://upload.wikimedia.org/wikipedia/en/4/47/Am%C3%A9rica_Futebol_Clube_%28MG%29_logo.svg',
    'Mirassol': 'https://upload.wikimedia.org/wikipedia/en/9/95/Mirassol_FC_logo.svg',
    ...
    'Atletico Mineiro': 'https://upload.wikimedia.org/wikipedia/en/e/ed/Atletico_Mineiro_logo.svg',
    'Gremio': 'https://upload.wikimedia.org/wikipedia/en/f/f1/Gremio_logo.svg',
    'Red Bull Bragantino': 'https://upload.wikimedia.org/wikipedia/en/9/98/Red_Bull_Bragantino_logo.svg',
    ...
    'River Plate': 'https://upload.wikimedia.org/wikipedia/en/e/ec/River_Plate_logo.svg',
    'Boca Juniors': 'https://upload.wikimedia.org/wikipedia/en/d/d3/Club_Atletico_Boca_Juniors_logo.svg',
    'Racing Club': 'https://upload.wikimedia.org/wikipedia/en/c/cd/Racing_Club_logo.svg',
    'Independiente': 'https://upload.wikimedia.org/wikipedia/en/b/b3/Club_Atletico_Independiente_logo.svg',
    'San Lorenzo': 'https://upload.wikimedia.org/wikipedia/en/2/23/Club_Atletico_San_Lorenzo_de_Almagro_logo.svg',
    'Estudiantes': 'https://upload.wikimedia.org/wikipedia/en/2/24/Estudiantes_de_La_Plata_logo.svg',
    'Vélez Sarsfield': 'https://upload.wikimedia.org/wikipedia/en/7/72/Velez_Sarsfield_logo.svg',
    'Lanús': 'https://upload.wikimedia.org/wikipedia/en/e/e8/Club_Atletico_Lanus_logo.svg',
    'Lanus': 'https://upload.wikimedia.org/wikipedia/en/e/e8/Club_Atletico_Lanus_logo.svg',
    'Argentinos Juniors': 'https://upload.wikimedia.org/wikipedia/en/c/cf/Argentinos_Juniors_logo.svg',
    'Godoy Cruz': 'https://upload.wikimedia.org/wikipedia/en/f/f2/Godoy_Cruz_logo.svg',
    'Talleres': 'https://upload.wikimedia.org/wikipedia/en/6/64/Club_Atletico_Talleres_logo.svg',
    'Newell\'s Old Boys': 'https://upload.wikimedia.org/wikipedia/en/c/c3/Newells_Old_Boys_logo.svg',
    'Banfield': 'https://upload.wikimedia.org/wikipedia/en/5/51/Club_Atletico_Banfield_logo.svg',
    'Tigre': 'https://upload.wikimedia.org/wikipedia/en/9/9e/Club_Atletico_Tigre_logo.svg',
    'Belgrano': 'https://upload.wikimedia.org/wikipedia/en/d/d7/Club_Atletico_Belgrano_logo.svg',
    'Belgrano de Cordoba': 'https://upload.wikimedia.org/wikipedia/en/d/d7/Club_Atletico_Belgrano_logo.svg',
    'Rosario Central': 'https://upload.wikimedia.org/wikipedia/en/4/49/Rosario_Central_logo.svg',
    'Atlético Tucuman': 'https://upload.wikimedia.org/wikipedia/en/7/76/Club_Atletico_Tucuman_logo.svg',
    'Atlético Tucumán': 'https://upload.wikimedia.org/wikipedia/en/7/76/Club_Atletico_Tucuman_logo.svg',
    'Barracas Central': 'https://upload.wikimedia.org/wikipedia/en/3/38/Club_Atletico_Barracas_Central_logo.svg',
    'Sarmiento': 'https://upload.wikimedia.org/wikipedia/en/7/70/Club_Atletico_Sarmiento_logo.svg',
    ...
    'SC Freiburg': 'https://upload.wikimedia.org/wikipedia/en/a/ac/SC_Freiburg_logo.svg',
    ...
    'Augsburg': 'https://upload.wikimedia.org/wikipedia/en/8/8c/FC_Augsburg_logo.svg',
    'Mainz': 'https://upload.wikimedia.org/wikipedia/commons/9/9e/Logo_Mainz_05.svg',
    '1. FC Heidenheim': 'https://upload.wikimedia.org/wikipedia/commons/e/e2/1._FC_Heidenheim_1846_logo.svg',
    'VfL Bochum': 'https://upload.wikimedia.org/wikipedia/commons/7/78/VfL_Bochum_logo.svg',
    'TSG Hoffenheim': 'https://upload.wikimedia.org/wikipedia/commons/e/e7/TSG_1899_Hoffenheim_logo.svg',
    '1. FC Köln': 'https://upload.wikimedia.org/wikipedia/en/1/19/1._FC_K%C3%B6ln_logo.svg',
    'FC St. Pauli': 'https://upload.wikimedia.org/wikipedia/commons/e/e1/Logo_FC_St._Pauli.svg',
    ...
    'SV Darmstadt 98': 'https://upload.wikimedia.org/wikipedia/commons/d/dc/SV_Darmstadt_98.svg',
    '1. FC Kaiserslautern': 'https://upload.wikimedia.org/wikipedia/commons/2/22/1._FC_Kaiserslautern_logo.svg',
    '1. FC Magdeburg': 'https://upload.wikimedia.org/wikipedia/commons/1/15/1._FC_Magdeburg_Logo.svg',
    '1. FC Nürnberg': 'https://upload.wikimedia.org/wikipedia/commons/f/fa/1._FC_N%C3%BCrnberg_logo.svg',
    'Arminia Bielefeld': 'https://upload.wikimedia.org/wikipedia/commons/4/40/DSC_Arminia_Bielefeld_logo.svg',
    'Dynamo Dresden': 'https://upload.wikimedia.org/wikipedia/commons/3/31/SG_Dynamo_Dresden_Logo.svg',
    'Karlsruher SC': 'https://upload.wikimedia.org/wikipedia/commons/8/8e/Karlsruher_SC_Logo.svg',
    'SV Elversberg': 'https://upload.wikimedia.org/wikipedia/commons/4/4a/SV_07_Elversberg_logo.svg',
    'Greuther Fürth': 'https://upload.wikimedia.org/wikipedia/commons/f/f7/SpVgg_Greuther_F%C3%BCrth_logo.svg',
    'Eintracht Braunschweig': 'https://upload.wikimedia.org/wikipedia/commons/d/d6/Eintracht_Braunschweig_Logo.svg',
    'SSV Ulm 1846': 'https://upload.wikimedia.org/wikipedia/commons/8/8e/SSV_Ulm_1846_logo.svg',
    'Preußen Münster': 'https://upload.wikimedia.org/wikipedia/commons/0/07/SC_Preu%C3%9Fen_M%C3%BCnster_Logo.svg',
    'Jahn Regensburg': 'https://upload.wikimedia.org/wikipedia/commons/0/0e/SSV_Jahn_Regensburg_Logo.svg',
    
    // Serie B
    'Spezia': 'https://upload.wikimedia.org/wikipedia/en/d/d9/Spezia_Calcio_logo.svg',
    'Brescia': 'https://upload.wikimedia.org/wikipedia/en/4/42/Brescia_Calcio_logo.svg',
    'Palermo': 'https://upload.wikimedia.org/wikipedia/en/1/19/US_Citt%C3%A0_di_Palermo_logo.svg',
    'Cremonese': 'https://upload.wikimedia.org/wikipedia/en/6/6e/US_Cremonese_logo.svg',
    'Bari': 'https://upload.wikimedia.org/wikipedia/en/9/94/SSC_Bari_logo.svg',
    'Sampdoria': 'https://upload.wikimedia.org/wikipedia/en/9/96/UC_Sampdoria_logo.svg',
    'Catanzaro': 'https://upload.wikimedia.org/wikipedia/en/b/b2/US_Catanzaro_1929_logo.svg',
    'US Catanzaro 1929': 'https://upload.wikimedia.org/wikipedia/en/b/b2/US_Catanzaro_1929_logo.svg',
    'Reggiana': 'https://upload.wikimedia.org/wikipedia/en/9/98/AC_Reggiana_1919_logo.svg',
    'Cosenza': 'https://upload.wikimedia.org/wikipedia/en/c/c7/Cosenza_Calcio_logo.svg',
    'Salernitana': 'https://upload.wikimedia.org/wikipedia/en/a/a8/US_Salernitana_1919_logo.svg',
    'Cittadella': 'https://upload.wikimedia.org/wikipedia/en/7/7c/AS_Cittadella_logo.svg',
    'Südtirol': 'https://upload.wikimedia.org/wikipedia/en/c/cd/FC_S%C3%BCdtirol_logo.svg',
    'Mantova': 'https://upload.wikimedia.org/wikipedia/en/d/dd/Mantova_1911_logo.svg',
    'Frosinone': 'https://upload.wikimedia.org/wikipedia/en/d/d6/Frosinone_Calcio_logo.svg',
    'Modena': 'https://upload.wikimedia.org/wikipedia/en/5/54/Modena_FC_logo.svg',
    'Cesena FC': 'https://upload.wikimedia.org/wikipedia/en/e/ea/Cesena_FC_logo.svg',
    'Juve Stabia': 'https://upload.wikimedia.org/wikipedia/en/9/90/SS_Juve_Stabia_logo.svg',
    'Carrarese': 'https://upload.wikimedia.org/wikipedia/en/9/95/Carrarese_Calcio_logo.svg',
...
/**
 * Get country flag for national team matches (World Cup Qualifiers, etc.)
 * @param {string} teamName - Name of the country/national team
 * @returns {Promise<string|null>} - URL of country flag or null
 */
export const getCountryFlag = async (teamName) => {
  if (!teamName) return null;
  
  // Comprehensive country code mapping for all FIFA members
  const countryCodeMap = {
    // UEFA (Europe)
    'Albania': 'al',
    'Andorra': 'ad',
