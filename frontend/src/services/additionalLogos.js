...
export const additionalFootballLogos = {
  ...
  // ENGLAND - League One (3rd Division)
  ...
  'Charlton Athletic': 'https://upload.wikimedia.org/wikipedia/commons/c/cf/Charlton_Athletic.svg',
  'Charlton': 'https://upload.wikimedia.org/wikipedia/commons/c/cf/Charlton_Athletic.svg',
  'Stockport County': 'https://upload.wikimedia.org/wikipedia/en/f/f4/Stockport_County_FC_logo.svg',
  'Stockport': 'https://upload.wikimedia.org/wikipedia/en/f/f4/Stockport_County_FC_logo.svg',
  ...
  // ENGLAND - League Two (4th Division)
  'Lincoln City': 'https://upload.wikimedia.org/wikipedia/en/4/40/Lincoln_City_FC.svg',
  'Lincoln': 'https://upload.wikimedia.org/wikipedia/en/4/40/Lincoln_City_FC.svg',
  'Doncaster Rovers': 'https://upload.wikimedia.org/wikipedia/en/3/3d/Doncaster_Rovers_F.C._logo.svg',
  'Doncaster': 'https://upload.wikimedia.org/wikipedia/en/3/3d/Doncaster_Rovers_F.C._logo.svg',
  'Crewe Alexandra': 'https://upload.wikimedia.org/wikipedia/en/9/9d/Crewe_Alexandra.svg',
  'Crewe': 'https://upload.wikimedia.org/wikipedia/en/9/9d/Crewe_Alexandra.svg',
  'Port Vale': 'https://upload.wikimedia.org/wikipedia/en/e/e8/Port_Vale_F.C._logo.svg',
  'Grimsby Town': 'https://upload.wikimedia.org/wikipedia/en/5/53/Grimsby_Town_F.C._logo.svg',
  'Grimsby': 'https://upload.wikimedia.org/wikipedia/en/5/53/Grimsby_Town_F.C._logo.svg',
  'Notts County': 'https://upload.wikimedia.org/wikipedia/en/9/93/Notts_County_FC.svg',
  'Bradford City': 'https://upload.wikimedia.org/wikipedia/en/3/34/Bradford_City_AFC.svg',
  'Bradford': 'https://upload.wikimedia.org/wikipedia/en/3/34/Bradford_City_AFC.svg',
  'Barrow': 'https://upload.wikimedia.org/wikipedia/en/9/9a/Barrow_AFC_logo.svg',
  'Chesterfield': 'https://upload.wikimedia.org/wikipedia/en/9/94/Chesterfield_FC_crest.svg',
  'Salford City': 'https://upload.wikimedia.org/wikipedia/en/2/29/Salford_City_FC_badge.svg',
  'Salford': 'https://upload.wikimedia.org/wikipedia/en/2/29/Salford_City_FC_badge.svg',
  'Milton Keynes Dons': 'https://upload.wikimedia.org/wikipedia/en/9/9b/Milton_Keynes_Dons_FC_logo.svg',
  'MK Dons': 'https://upload.wikimedia.org/wikipedia/en/9/9b/Milton_Keynes_Dons_FC_logo.svg',
  'Gillingham': 'https://upload.wikimedia.org/wikipedia/en/5/5b/Gillingham_F.C._logo.svg',
  'Carlisle United': 'https://upload.wikimedia.org/wikipedia/en/4/4a/Carlisle_United_F.C._logo.svg',
  'Carlisle': 'https://upload.wikimedia.org/wikipedia/en/4/4a/Carlisle_United_F.C._logo.svg',
  'Colchester United': 'https://upload.wikimedia.org/wikipedia/en/7/74/Colchester_United_FC.svg',
  'Colchester': 'https://upload.wikimedia.org/wikipedia/en/7/74/Colchester_United_FC.svg',
  'Swindon Town': 'https://upload.wikimedia.org/wikipedia/en/6/6a/Swindon_Town_FC.svg',
  'Swindon': 'https://upload.wikimedia.org/wikipedia/en/6/6a/Swindon_Town_FC.svg',
  'Accrington Stanley': 'https://upload.wikimedia.org/wikipedia/en/1/1d/Accrington_Stanley_FC.svg',
  'Accrington': 'https://upload.wikimedia.org/wikipedia/en/1/1d/Accrington_Stanley_FC.svg',
  'Tranmere Rovers': 'https://upload.wikimedia.org/wikipedia/en/c/c2/Tranmere_Rovers_F.C._logo.svg',
  'Tranmere': 'https://upload.wikimedia.org/wikipedia/en/c/c2/Tranmere_Rovers_F.C._logo.svg',
  ...
  'Morecambe': 'https://upload.wikimedia.org/wikipedia/en/e/e9/Morecambe_F.C._logo.svg',
  ...
  'Cheltenham Town': 'https://upload.wikimedia.org/wikipedia/en/8/87/Cheltenham_Town_F.C._logo.svg',
  'Cheltenham': 'https://upload.wikimedia.org/wikipedia/en/8/87/Cheltenham_Town_F.C._logo.svg',
  'Harrogate Town': 'https://upload.wikimedia.org/wikipedia/en/c/c4/Harrogate_Town_A.F.C._logo.svg',
  'Harrogate': 'https://upload.wikimedia.org/wikipedia/en/c/c4/Harrogate_Town_A.F.C._logo.svg',
  'Bromley': 'https://upload.wikimedia.org/wikipedia/en/6/62/Bromley_F.C._logo.svg',
  'Fleetwood Town': 'https://upload.wikimedia.org/wikipedia/en/c/c4/Fleetwood_Town_F.C._logo.svg',
  'Fleetwood': 'https://upload.wikimedia.org/wikipedia/en/c/c4/Fleetwood_Town_F.C._logo.svg',
