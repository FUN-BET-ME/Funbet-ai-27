      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            Other Sports <span className="text-[#FFD700]">Odds</span>
          </h1>
          <p className="text-gray-400 text-lg mb-6">
            Compare real-time odds from top bookmakers around the world for basketball, tennis, baseball, hockey, and more for the next 7 days.
        ...
        {/* Odds Table */}
        <OddsTable sportKeys={['basketball_nba', 'icehockey_nhl', 'baseball_mlb', 'tennis_atp_french_open', 'mma_mixed_martial_arts']} sportTitle="Other Sports" />
...
export default OtherSportsOdds;