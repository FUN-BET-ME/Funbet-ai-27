      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            Football <span className="text-[#FFD700]">Odds</span>
          </h1>
          <p className="text-gray-400 text-lg mb-6">
            Compare real-time football odds from top bookmakers around the world for the next 7 days.
        ...
        {/* Odds Table */}
        <OddsTable sportKeys={['soccer_epl', 'soccer_spain_la_liga', 'soccer_germany_bundesliga', 'soccer_italy_serie_a', 'soccer_france_ligue_one']} sportTitle="Football" usePriorityEndpoint={true} />
