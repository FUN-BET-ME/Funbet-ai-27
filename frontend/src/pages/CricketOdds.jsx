      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            Cricket <span className="text-[#FFD700]">Odds</span>
          </h1>
          <p className="text-gray-400 text-lg mb-6">
            Compare real-time cricket odds (IPL, World Cup, Test Matches, T20) from top bookmakers around the world for the next 7 days.
        ...
        {/* Odds Table */}
        <OddsTable sportKeys={['cricket_ipl', 'cricket_big_bash', 'cricket_test_match', 'cricket_odi']} sportTitle="Cricket" usePriorityEndpoint={true} />
