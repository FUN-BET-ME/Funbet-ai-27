      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            Golf <span className="text-[#FFD700]">Odds</span>
          </h1>
          <p className="text-gray-400 text-lg mb-6">
            Compare real-time golf tournament odds from top bookmakers around the world for the next 7 days.
        ...
        {/* Odds Table */}
        <OddsTable sportKeys={['golf_masters', 'golf_pga_championship', 'golf_us_open']} sportTitle="Golf" />
