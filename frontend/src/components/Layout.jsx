...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'NFL', path: '/live-odds?sport=basketball', canHighlight: false },
    { name: 'Hockey', path: '/live-odds?sport=hockey', canHighlight: false },
    { name: 'Basketball', path: '/live-odds?sport=basketball', canHighlight: false },
