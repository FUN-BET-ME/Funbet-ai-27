                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 mt-3">
                      ...
                      <div className="flex-1 min-w-0">
                        {/* First Line: Team Names with VS - Full width, word wrap */}
                        <div className="flex items-center gap-2">
                          <span className="text-white font-semibold break-words leading-tight text-sm sm:text-base flex-1">{match.home_team}</span>
                          <span className="text-gray-400 text-xs sm:text-sm font-medium px-2 flex-shrink-0">vs</span>
                          <span className="text-white font-semibold break-words leading-tight text-right text-sm sm:text-base flex-1 text-right">{match.away_team}</span>
                        </div>
                    ...
                    <table className="w-full table-fixed">
                      <thead>
                        <tr className="border-b border-[#2E004F]/30">
                          <th className="text-left py-1.5 px-0.5 sm:py-3 sm:px-4 text-[9px] sm:text-sm font-semibold text-gray-400 w-[28%] sm:w-auto">
                            <span className="truncate block">Bookmaker</span>
                          </th>
                          {(() => {
                            ...
                            // Check if sport allows draws (ONLY football/soccer and cricket - NOT basketball!)
