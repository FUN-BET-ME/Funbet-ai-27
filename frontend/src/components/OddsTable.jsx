...
const OddsTable = ({ sportKeys, sportTitle, usePriorityEndpoint = false, refreshTrigger = 0, timeFilter = 'live-upcoming', showAllRows = false, preloadedOdds = null, loading: externalLoading = null, selectedLeague = null }) => {
  ...
  useEffect(() => {
    ...
    fetchOdds();
    fetchAIPredictions(); // Fetch API predictions on mount
                      ...
                      <thead>
                        <tr className="border-b border-[#2E004F]/30">
                          ...
                          {(() => {
                            ...
                            headers.push(
                              <th key="home" className="text-center py-3 px-4 text-sm font-semibold text-gray-400">
                                <button
                                  onClick={() => {
                                    setOddsSortBy(prev => ({
                                      ...prev,
                            ...
                            headers.push(
                              <th key="away" className="text-center py-3 px-4 text-sm font-semibold text-gray-400">
                                <button
                                  onClick={() => {
                                    setOddsSortBy(prev => ({
                                      ...prev,
