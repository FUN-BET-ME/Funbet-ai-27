...
curl "https://bookmaker-refresh.preview.emergentagent.com/api/cricket/live" | jq '.'

# Test recent cricket results
curl "https://bookmaker-refresh.preview.emergentagent.com/api/cricket/recent" | jq '.'
```
