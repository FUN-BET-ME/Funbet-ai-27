...
curl "https://odds-calculator-fix-1.preview.emergentagent.com/api/cricket/live" | jq '.'

# Test recent cricket results
curl "https://odds-calculator-fix-1.preview.emergentagent.com/api/cricket/recent" | jq '.'
```
